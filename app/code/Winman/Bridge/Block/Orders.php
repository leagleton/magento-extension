...
class Orders extends Template
{
    ...
    /**
     * Fetch the orders from the WinMan REST API. If $id is defined, fetch only
     * the specified order.
    ...
    {
        return $this->getUrl('customerportal/portal/orders')
    ...
    /**
     * Place the shipping order item at the end of the array so it appears last
     * in the list of order items.
     *
     * @param array $array
     * @return array
     */
